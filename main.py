...
if num >= 83:
    ...
    is_next = False
print("ЗАДАЧА #1 :", "Candidate passes to the next round:", is_next)
...
print("ЗАДАЧА #2 :", "Developer type:", developer_type)
...
print(f"ЗАДАЧА #5 : Total number of characters ({search}) in the string: {result}")
...
try:
    ...
    print("ЗАДАЧА #6 :", "Size of each SMS package:", chunk)
except ZeroDivisionError:
    print("ЗАДАЧА #6 :", "Divide by zero completed!")
...
def invite_to_event(username):
    return f"ЗАДАЧА #8 : Dear {username}, we have the honour to invite you to our event"

result = invite_to_event("Andrii")
print(result)
...
def discount_price(price, discount):
    ...
    apply_discount()
    return price
print("ЗАДАЧА #9 :", "Discounted price: ", discount_price(100, 0.2))
...
print("ЗАДАЧА #10 :", get_fullname("Andrii", "Barinov"))
print("ЗАДАЧА #10 :", get_fullname("Andrii", "Barinov", "Yuriiovych"))
...
print("ЗАДАЧА #11 :", formatted_result)
...
print("ЗАДАЧА #12 :", first(5, "first", "second", "third"))
print("ЗАДАЧА #12 :", first(1, "Alex", "Boris"))
print("ЗАДАЧА #12 :", second(3, comment_one="first", comment_two="second", comment_third="third"))
print("ЗАДАЧА #12 :", second(10, comment_one="Alex", comment_two="Boris"))
...
def number_of_groups(n, k):
    ...
    combination = n_factorial // (nk_factorial * k_factorial)
    
    return combination

n = 50
k = 7
print("ЗАДАЧА #13 :", "Number of different groups of winners:", number_of_groups(n, k))